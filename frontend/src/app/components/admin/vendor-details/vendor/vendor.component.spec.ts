...
describe('BasicDetailsComponent', () => {
  let component: AdminVendorDetailsVendorComponent;
  let fixture: ComponentFixture<AdminVendorDetailsVendorComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AdminVendorDetailsVendorComponent);
