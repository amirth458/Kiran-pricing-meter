...
@Component({
  selector: 'app-project-release-queue',
  templateUrl: './project-release-queue.component.html',
  styleUrls: ['./project-release-queue.component.css']
})
export class ProjectReleaseQueueComponent implements OnInit {
  autoQuotedIds = [];
  columnDefs = [];
